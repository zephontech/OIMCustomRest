 ...
 * 
 */
public class OIMlookupUtilities {
    ...
    public static final Logger logger = SuperLogger.getLogger();
     ...
     */
    public OIMlookupUtilities() throws Exception {

        lookupOp = Platform.getService(Thor.API.Operations.tcLookupOperationsIntf.class);

        if (lookupOp == null) {
            logger.severe("Failed to get lookupOps");
            throw new Exception("lookupOps Failed");
        }
     ...
     * @exception Exception
     */
    public Map<String,String> getLookupValues(String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.getLookupValues()");
        ...
        {
            throw new Exception("tcAPIException",e);
        }
        catch(tcInvalidLookupException e)
        {
            throw new Exception("tcInvalidLookupException",e);
        }
        catch(tcColumnNotFoundException e)
        {
            throw new Exception("tcColumnNotFoundException",e);
        }
        logger.info("Exiting OIMlookupUtilities.getLookupValues()");
        return result;
    }
    ...
    public String getLookupValue(String Key, String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.getLookupValue()");
        String result = "";
        ...
        try
        {
            ...
            for (int i = 0; i < results.getRowCount(); i++) {
                ...
                if (results.getStringValue("Lookup Definition.Lookup Code Information.Code Key").equalsIgnoreCase(Key)) {
                    logger.info(Key + " was found in the lookup table");
        ...
        logger.info("Exiting OIMlookupUtilities.getLookupValue()");
        return result;
    }
    ...
    public String[] getLookupKeys(String Value, String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.getLookupKeys()");
        ...
        try
        {
            ...
            for (int i = 0; i < results.getRowCount(); i++) {
                ...
                if (results.getStringValue("Lookup Definition.Lookup Code Information.Decode").equalsIgnoreCase(Value)) {
                    logger.info(Value + " was found in the lookup table");
        ...
        logger.info("Exiting OIMlookupUtilities.getLookupKeys()");
    ...
    public void addLookupValue(String Key, String Value, String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.addLookupValue()");
        try
        {
        ...
        {
            throw new Exception("tcInvalidValueException",e);
        }

        logger.info("Exiting OIMlookupUtilities.addLookupValue()");
    }
    ...
    public void updateLookupValue(String Key, String Value, String Lookup, boolean ExactMatch) throws Exception {
        logger.info("Entering OIMlookupUtilities.updateLookupValue()");
        ...
        logger.info("Exiting OIMlookupUtilities.updateLookupValue()");
    }

    public void updateLookupValue(String key, String value, String lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.updateLookupValue()");
        ...
        {
            throw new Exception("tcInvalidAttributeException",e);
        }
    ...
    public void removeLookupValue(String Key, String Lookup, boolean ExactMatch) throws Exception {
        logger.info("Entering OIMlookupUtilities.removeLookupValue()");
        ...
        logger.info("Exiting OIMlookupUtilities.removeLookupValue()");
    }
    ...
    public void createLookup(String Lookup) throws Exception {
        ...
        logger.info("Entering OIMlookupUtilities.createLookup()");
        try
        {
        ...
        {
            logger.severe("Table Already Exists");
        }
        logger.info("Exiting OIMlookupUtilities.createLookup()");
    }
    ...
    public void clearLookup(String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.clearLookup()");
        try
        {
            tcResultSet results = lookupOp.getLookupValues(Lookup);
            for (int i = 0; i < results.getRowCount(); i++) {
        ...
        logger.info("Exiting OIMlookupUtilities.clearLookup()");
    }
    ...
    public void removeLookup(String Lookup) throws Exception {
        logger.info("Entering OIMlookupUtilities.removeLookup()");
        try
        {
            //clearLookup(Lookup);
        ...
        logger.info("Exiting OIMlookupUtilities.removeLookup()");
    }
}
